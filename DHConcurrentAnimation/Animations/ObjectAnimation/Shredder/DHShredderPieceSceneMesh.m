...
}DHShredderPieceSceneMeshAttributes;

@interface DHShredderPieceSceneMesh()
@property (nonatomic, weak) UIView *targetView;
@property (nonatomic, weak) UIView *containerView;
@end

@implementation DHShredderPieceSceneMesh
...
- (void) generateMeshesData
{
    ...
    DHShredderPieceSceneMeshAttributes *vertices = malloc(self.vertexCount * sizeof(DHShredderPieceSceneMeshAttributes));
    ...
    self.vertexData = [NSData dataWithBytesNoCopy:vertices length:self.vertexCount * sizeof(DHShredderPieceSceneMeshAttributes) freeWhenDone:YES];
...
- (void) prepareToDraw
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(DHShredderPieceSceneMeshAttributes), NULL + offsetof(DHShredderPieceSceneMeshAttributes, position));
    
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(DHShredderPieceSceneMeshAttributes), NULL + offsetof(DHShredderPieceSceneMeshAttributes, texCoords));
    
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 1, GL_FLOAT, GL_FALSE, sizeof(DHShredderPieceSceneMeshAttributes), NULL + offsetof(DHShredderPieceSceneMeshAttributes, radius));
    
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, sizeof(DHShredderPieceSceneMeshAttributes), NULL + offsetof(DHShredderPieceSceneMeshAttributes, columnCenter));
    
    glEnableVertexAttribArray(4);
    glVertexAttribPointer(4, 1, GL_FLOAT, GL_FALSE, sizeof(DHShredderPieceSceneMeshAttributes), NULL + offsetof(DHShredderPieceSceneMeshAttributes, shredderedZOffset));
    glBindVertexArray(0);
}
